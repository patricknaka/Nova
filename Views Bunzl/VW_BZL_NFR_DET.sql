...
--**********************************************************************************************************************************************************
  ...
  tdrec941.t$qnty$l QT_NOMINAL_NF,
  	(SELECT sum(tdrec947.t$qnty$l) FROM baandb.ttdrec947602 tdrec947
  ...
  (SELECT tdrec942.t$rate$l FROM baandb.ttdrec942602 tdrec942
  ...
  (SELECT tdrec942.t$sbas$l FROM baandb.ttdrec942602 tdrec942
  WHERE tdrec942.t$fire$l=tdrec941.t$fire$l
  AND tdrec942.t$line$l=tdrec941.t$line$l
  ...
  (SELECT tdrec942.t$amnt$l FROM baandb.ttdrec942602 tdrec942
  WHERE tdrec942.t$fire$l=tdrec941.t$fire$l
  AND tdrec942.t$line$l=tdrec941.t$line$l
  ...
  AND tdrec942.t$brty$l=2) VL_ICMS_ST,
	nvl((SELECT tdrec942.t$amnt$l FROM baandb.ttdrec949602 tdrec949, baandb.ttdrec942602 tdrec942
  ...
  AND tdrec942.t$brty$l=3) VL_IPI,
   (SELECT tdrec942.t$amnr$l FROM baandb.ttdrec942602 tdrec942
  WHERE tdrec942.t$fire$l=tdrec941.t$fire$l
  AND tdrec942.t$line$l=tdrec941.t$line$l
  ...
  FROM baandb.ttdrec942602 tdrec942
  WHERE tdrec942.t$fire$l=tdrec941.t$fire$l
  AND tdrec942.t$line$l=tdrec941.t$line$l
  AND tdrec942.t$brty$l=1) as numeric (12,2)) VL_BASE_ICMS_NAO_REDUTOR,  

  (SELECT tdrec942.t$amni$l FROM baandb.ttdrec942602 tdrec942
  WHERE tdrec942.t$fire$l=tdrec941.t$fire$l
  AND tdrec942.t$line$l=tdrec941.t$line$l
  AND tdrec942.t$brty$l=1) VL_ICMS_MERCADORIA,
  nvl((SELECT sum(tdrec942.t$amnt$l) FROM baandb.ttdrec942602 tdrec942, 
											baandb.ttdrec941602 tdrec941b,
											baandb.ttcibd001602 tcibd001b
  WHERE tdrec942.t$fire$l=tdrec941.t$fire$l
  ...
  AND tdrec942.t$brty$l=6) VL_COFINS_MERCADORIA,
	nvl((SELECT sum(tdrec942.t$amnt$l) FROM baandb.ttdrec942602 tdrec942, 					--#FAF.242.sn
												baandb.ttdrec941602 tdrec941b,
												baandb.ttcibd001602 tcibd001b
  ...
  (SELECT tdrec942.t$base$l FROM baandb.ttdrec942602 tdrec942
  WHERE tdrec942.t$fire$l=tdrec941.t$fire$l
  AND tdrec942.t$line$l=tdrec941.t$line$l
  AND tdrec942.t$brty$l=3) VL_BASE_IPI,
  (SELECT tdrec942.t$rdbc$l FROM baandb.ttdrec942602 tdrec942											--#FAF.279.n
  WHERE tdrec942.t$fire$l=tdrec941.t$fire$l
  AND tdrec942.t$line$l=tdrec941.t$line$l
 ...
 (SELECT tdrec942.t$amnr$l FROM baandb.ttdrec942602 tdrec942
  ...
  AND tdrec942.t$brty$l=1) VL_ICMS_DESTACADO, 
  	nvl((select sum(ra.t$qrec) from baandb.twhinh312602 ra, baandb.ttdrec947602 rr
  	...
  	(SELECT tdrec947.t$orno$l FROM baandb.ttdrec947602 tdrec947
	WHERE tdrec947.t$fire$l=tdrec941.t$fire$l
	AND tdrec947.t$line$l=tdrec941.t$line$l
