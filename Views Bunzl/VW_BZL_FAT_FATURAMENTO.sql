...
--**********************************************************************************************************************************************************
  ...
  CASE WHEN (	SELECT tcemm030.t$euca FROM baandb.ttcemm124602 tcemm124, baandb.ttcemm030602 tcemm030	
...
THEN
  ...
  AND tcemm124.t$loco=602
  AND rownum=1)
ELSE (	SELECT tcemm030.t$euca FROM baandb.ttcemm124602 tcemm124, baandb.ttcemm030602 tcemm030
        WHERE tcemm124.t$cwoc=cisli940.t$cofc$l
        AND tcemm030.t$eunt=tcemm124.t$grid
        AND tcemm124.t$loco=602
        AND rownum=1)
  ...
  CASE WHEN cisli940.t$fdty$l=15 then (select distinct a.t$docn$l from baandb.tcisli940602 a, baandb.tcisli941602 b
                                                                where b.t$fire$l=cisli940.t$fire$l
                                                                and a.t$fire$l=b.t$refr$l and rownum=1) else 0
  end NR_NF_FATURA,
  CASE WHEN cisli940.t$fdty$l=15 then (select distinct a.t$seri$l from baandb.tcisli940602 a, baandb.tcisli941602 b
                                                                  where b.t$fire$l=cisli940.t$fire$l
                                                                  and a.t$fire$l=b.t$refr$l and rownum=1) else ' '
  end NR_SERIE_NF_FATURA,
  CASE WHEN cisli940.t$fdty$l=16 then (select distinct a.t$docn$l from baandb.tcisli940602 a, baandb.tcisli941602 b
                                                                  where b.t$fire$l=cisli940.t$fire$l and a.t$fire$l=b.t$refr$l and rownum=1) else 0
  end NR_NF_REMESSA,
  CASE WHEN cisli940.t$fdty$l=16 then (select distinct a.t$seri$l from baandb.tcisli940602 a, baandb.tcisli941602 b 
                                                                  where b.t$fire$l=cisli940.t$fire$l
                                                                  and a.t$fire$l=b.t$refr$l and rownum=1) else ' '
  ...
  (Select CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(max(brnfe020.t$date$l), 'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
   ...
   FROM baandb.tbrnfe020602 brnfe020
   Where brnfe020.t$refi$l=cisli940.t$fire$l AND brnfe020.t$ncmp$l=602) 
  AS DT_STATUS,
  cisli940.t$fdty$l CD_TIPO_NF,
  ltrim(rtrim(cisli941f.t$item$l)) CD_ITEM,
  cisli941f.t$dqua$l QT_FATURADA,
  nvl(ICMS.t$amnt$l, 0) VL_ICMS,	--#FAF.602.n
  Nvl((SELECT cisli943.t$amnt$l from baandb.tcisli943602 cisli943 WHERE cisli943.t$fire$l=cisli941f.t$fire$l
                                                                  AND cisli943.t$line$l=cisli941f.t$line$l
                                                                  AND cisli943.t$brty$l=2),0) 
  AS VL_ICMS_ST,
  cisli941f.t$gamt$l VL_PRODUTO,
  znsls401.t$vlfr$c VL_FRETE,
  nvl((select sum(f.t$vlfc$c) from baandb.tznfmd630602 f where f.t$fire$c=cisli940.t$fire$l),0) * (cisli941f.t$gamt$l/nvl((select sum(cisli941b.t$gamt$l)
                              from baandb.tcisli941602 cisli941b, baandb.ttcibd001602 tcibd001b
  ...
  TRUNC(case when cisli941.t$item$l not in	
        (select a.t$itjl$c
        from baandb.tznsls000602 a
        where a.t$indt$c=(select min(b.t$indt$c) from baandb.tznsls000602 b)
    UNION ALL
    select a.t$itmd$c
    from baandb.tznsls000602 a
    where a.t$indt$c=(select min(b.t$indt$c) from baandb.tznsls000602 b)
    ...
    nvl((select sum(c.t$amnt$l) from baandb.tcisli941602 c
    where c.t$fire$l=cisli941.t$fire$l
    and c.t$item$l=(select a.t$itmd$c
                    from baandb.tznsls000602 a
                    where a.t$indt$c=(select min(b.t$indt$c) from baandb.tznsls000602 b))),0)/ (cisli941.t$gamt$l/cisli940.t$gamt$l)
                    else 0 end
                    else 0 end,2) 
  AS VL_DESPESA,
  ...
  cisli941f.t$fght$l*(nvl(ICMS.t$rate$l,0)/100) VL_ICMS_FRETE,
    ...
    ELSE 0 END	
  AS VL_ICMS_OUTROS,	
  nvl(COFINS.t$amnt$l,0) VL_COFINS,	--#FAF.602.n
  ...
  nvl((select sum(b.t$mauc$1) from baandb.twhina114602 a, baandb.twhina113602 b
  ...
  Nvl((SELECT cisli943.t$base$l from baandb.tcisli943602 cisli943
       WHERE cisli943.t$fire$l=cisli941f.t$fire$l
       AND cisli943.t$line$l=cisli941f.t$line$l
       AND cisli943.t$brty$l=3),0) VL_BASE_IPI,
       nvl((select t.t$suno from baandb.ttcmcs080602 t where t.t$cfrw=cisli940.t$cfrw$l and rownum=1),' ') 
  ...
  AS DT_ENTREGA,
    (Select sum(znfmd630.t$qvol$c) From baandb.tznfmd630602 znfmd630 WHERE znfmd630.t$fire$c=cisli941f.t$fire$l and rownum=1) 
  AS QT_VOLUME,
  ...
  znsls400.t$idli$c NR_LISTA_CASAMENTO,
    (SELECT tcemm124.t$grid FROM baandb.ttcemm124602 tcemm124
     WHERE tcemm124.t$cwoc=cisli940.t$cofc$l
    AND tcemm124.t$loco=602 AND rownum=1) 
  AS CD_UNIDADE_EMPRESARIAL,
    (select CASE WHEN regexp_replace(e.t$fovn$l, '[^0-9]', '') IS NULL
            ...
            from baandb.ttccom130602 e where e.t$cadr=cisli940.t$stoa$l and rownum=1) 
  AS NR_CNPJ_CPF_ENTREGA,
    (select e.t$ftyp$l from baandb.ttccom130602 e where e.t$cadr=cisli940.t$stoa$l and rownum=1) 
  AS CD_TIPO_CLIENTE_ENTREGA,
    (select CASE WHEN regexp_replace(e.t$fovn$l, '[^0-9]', '') IS NULL
            ...
            THEN '00000000000000'
            ELSE regexp_replace(e.t$fovn$l, '[^0-9]', '') END 
            from baandb.ttccom130602 e where e.t$cadr=cisli940.t$itoa$l and rownum=1) 
  AS NR_CNPJ_CPF_FATURA,
    (select e.t$ftyp$l from baandb.ttccom130602 e where e.t$cadr=cisli940.t$itoa$l and rownum=1) 
  ...
  --INICIO DO FROM
FROM baandb.tcisli940602 cisli940,
     baandb.tcisli941602 cisli941,	
     baandb.tcisli941602 cisli941f 
LEFT JOIN baandb.tcisli943602 ICMS	ON ICMS.t$fire$l=cisli941f.t$fire$l	
     AND	ICMS.t$line$l=cisli941f.t$line$l
     AND ICMS.t$brty$l=1
LEFT JOIN baandb.tcisli943602 COFINS ON COFINS.t$fire$l=cisli941f.t$fire$l	
     AND	COFINS.t$line$l=cisli941f.t$line$l
     AND COFINS.t$brty$l=6
LEFT JOIN baandb.tcisli943602 PIS ON PIS.t$fire$l=cisli941f.t$fire$l	
     AND	PIS.t$line$l=cisli941f.t$line$l
     AND PIS.t$brty$l=5
LEFT JOIN baandb.tcisli943602 CSLL ON CSLL.t$fire$l=cisli941f.t$fire$l	
     AND	CSLL.t$line$l=cisli941f.t$line$l
     AND CSLL.t$brty$l=13,
baandb.tcisli245602 cisli245,
baandb.ttdsls401602 tdsls401,
baandb.tznsls004602 znsls004,	--Origem OV
...
(select 
 ...
 from	baandb.tznsls402602 znsls402q
  group by
    znsls402q.t$ncia$c,
    znsls402q.t$uneg$c,
    znsls402q.t$pecl$c,
...
LEFT JOIN ( select c245.T$SLSO, c940.T$DOCN$L NOTA, c940.t$seri$l SERIE
            ...
            inner join baandb.tcisli941602 c941 on c941.t$fire$l=c245.T$FIRE$L   
