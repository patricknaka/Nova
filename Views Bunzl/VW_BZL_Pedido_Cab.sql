...
GROUP BY 
		to_char(ZNSLS401.T$ENTR$C),ZNSLS400.T$DTEM$C, to_char(ZNSLS400.T$ICLF$C), ZNSLS401.T$LOGE$C,
		ZNSLS401.T$NUME$C, ZNSLS401.T$COME$C, ZNSLS401.T$BAIE$C, ZNSLS401.T$CIDE$C, ZNSLS401.T$UFEN$C,	
		to_char(ZNSLS401.T$CEPE$C), ZNSLS400.T$VLFR$C, ZNSLS401.T$DTEP$C, to_char(ZNSLS401.T$IDTR$C), 
		to_char(ZNSLS400.T$PEEX$C)