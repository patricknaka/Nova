...
--**********************************************************************************************************************************************************
    ...
    CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(cisli940.t$date$l, 'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
		...
		(SELECT cisli942.t$amnt$l FROM baandb.tcisli942602 cisli942
		...
		(SELECT sum(cisli941.t$ldam$l) FROM baandb.tcisli941602 cisli941
		WHERE cisli941.t$fire$l=cisli940.t$fire$l) VL_DESCONTO,
		cisli940.t$amnt$l VL_TOTAL_NF,
        CASE WHEN cisli940.t$fdty$l=15 then
          (select a.t$docn$l from baandb.tcisli940602 a, baandb.tcisli941602 b
       ...
       CASE WHEN cisli940.t$fdty$l=15 then
          (select a.t$seri$l from baandb.tcisli940602 a, baandb.tcisli941602 b
          where b.t$fire$l=cisli940.t$fire$l
          and a.t$fire$l=b.t$refr$l
          and rownum=1
          group by a.t$seri$l)
        ...
        Nvl((SELECT sum(cisli943.t$amnt$l) from baandb.tcisli943602 cisli943
		...
		nvl((select sum(l.t$gexp$l) from baandb.tcisli941602 l
		where	l.t$fire$l = cisli940.t$fire$l
		and (l.t$sour$l=2 or l.t$sour$l=8)),0) VL_ADICIONAL_IMPORTACAO,
		nvl((select sum(li.t$amnt$l) from baandb.tcisli943602 li, baandb.tcisli941602 l
		where	l.t$fire$l = cisli940.t$fire$l
		...
		nvl((select sum(l.t$fght$l) from baandb.tcisli941602 l
		where	l.t$fire$l = cisli940.t$fire$l
	...
	nvl((select CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(max(c1.t$rcd_utc), 'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
			AT time zone 'America/Sao_Paulo') AS DATE) from baandb.tcisli941602 c1 
	...
	nvl((select CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(max(c2.t$rcd_utc), 'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
			AT time zone 'America/Sao_Paulo') AS DATE) from baandb.tcisli943602 c2 
