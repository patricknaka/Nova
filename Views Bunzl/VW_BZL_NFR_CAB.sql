...
--**********************************************************************************************************************************************************
  602 CD_CIA,
	...
	AND rownum=1) = ' ' THEN SUBSTR((SELECT tcemm124.t$grid FROM baandb.ttcemm124602 tcemm124, baandb.ttcemm030602 tcemm030
	WHERE tcemm124.t$cwoc=tdrec940.t$cofc$l
	AND tcemm124.t$loco=602 AND rownum=1),5,2) ELSE (SELECT tcemm030.t$euca FROM baandb.ttcemm124602 tcemm124, baandb.ttcemm030602 tcemm030
	WHERE tcemm124.t$cwoc=tdrec940.t$cofc$l
	AND tcemm030.t$eunt=tcemm124.t$grid
	AND tcemm124.t$loco=602
	AND rownum=1) END  CD_FILIAL,	
	(SELECT tdrec947.t$rcno$l FROM baandb.ttdrec947602 tdrec947
	...
	(Select a.t$fire$l from baandb.ttdrec944602 a, baandb.ttdrec940602 b
	...
	(SELECT tdrec949.t$base$l FROM baandb.ttdrec949602 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	AND tdrec949.t$brty$l=1) VL_BASE_ICMS,
	(SELECT tdrec949.t$amnt$l FROM baandb.ttdrec949602 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	AND tdrec949.t$brty$l=1) VL_ICMS,
	(SELECT tdrec949.t$amnt$l FROM baandb.ttdrec949602 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	AND tdrec949.t$brty$l=2) VL_ICMS_ST,
	(SELECT sum(tdrec942.t$amnr$l) FROM baandb.ttdrec942602 tdrec942
...
--	AND tdrec942.t$brty$l=1) VL_IPI_DESTACADO,                                  --#FAF.238.o
	...
	nvl((	select sum(a.t$tamt$l) from baandb.ttdrec941602 a, baandb.ttcibd001602 b
--			where a.t$fire$l=tdrec941.t$fire$l																--#FAF.094.o
	...
	nvl((select t.t$text from baandb.ttttxt010602 t 
	where t$clan='p'
	...
	nvl((SELECT tdrec949.t$amnt$l FROM baandb.ttdrec949602 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	...
	nvl((select sum(l.t$gexp$l) from baandb.ttdrec941602 l
		where	l.t$fire$l = tdrec940.t$fire$l
		and (l.t$sour$l=2 or l.t$sour$l=8)),0) VL_ADICIONAL_IMPORTACAO,
	nvl((select sum(li.t$amnt$l) from baandb.ttdrec942602 li, baandb.ttdrec941602 l
		where	l.t$fire$l = tdrec940.t$fire$l
	...
	/*nvl((select sum(l.t$fght$l) from baandb.ttdrec941602 l
		where	l.t$fire$l = tdrec940.t$fire$l
		and l.t$crpd$l = 1),0)*/ 
    CAST(nvl((select sum(l.t$fght$l) from baandb.ttdrec941602 l
		where	l.t$fire$l = tdrec940.t$fire$l
		and l.t$crpd$l = 1),0) as numeric (18,2)) VL_CIF,
	nvl((select lr.t$mdev$c from baandb.twhinh312602 lr, baandb.ttdrec947602 rf
	...
	nvl((Select max(d.t$crpd$l) from baandb.ttdrec941602 d
	where d.t$fire$l=tdrec940.t$fire$l),2) CD_TIPO_FRETE,																
	nvl((SELECT tdrec949.t$isco$c FROM baandb.ttdrec949602 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	AND tdrec949.t$brty$l=2),2) IN_ICMS_ST_SEM_CONVENIO,
	(SELECT tcemm124.t$grid FROM baandb.ttcemm124602 tcemm124, baandb.ttcemm030602 tcemm030
	WHERE tcemm124.t$cwoc=tdrec940.t$cofc$l
	AND tcemm124.t$loco=602 AND rownum=1) CD_UNIDADE_EMPRESARIAL,
	tdrec940.t$fire$l NR_REFERENCIA_FISCAL,
	nvl((select ca.t$recd$c from baandb.twhinh300602 ca														--#FAF.199.n
...
FROM
	baandb.ttdrec940602 tdrec940
	LEFT JOIN baandb.ttccom966602 tccom966 ON tccom966.t$comp$d=tdrec940.t$fovn$l
	LEFT JOIN baandb.ttdrec940602 tdrec940r ON tdrec940r.t$fire$l=tdrec940.t$rref$l
	LEFT JOIN (	select 	min(a.t$rfdv$c) rfdv,
						a.t$fire$l
				from baandb.ttdrec941602 a
				where a.t$rfdv$c!=' '
				group by a.t$fire$l) REFDEV	ON REFDEV.t$fire$l = tdrec940r.t$fire$l
	LEFT JOIN baandb.tcisli940602 cisli940 	ON cisli940.t$fire$l = REFDEV.rfdv
