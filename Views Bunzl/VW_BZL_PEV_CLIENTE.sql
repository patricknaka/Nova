...
INNER JOIN (select 	znsls004q.t$ncia$c,
                    ...
                    znsls004q.t$sequ$c,
					znsls004q.t$orno$c
			from baandb.tznsls004602 znsls004q
			where znsls004q.t$date$c=(select max(q004.t$date$c) from baandb.tznsls004602 q004
...
INNER JOIN baandb.ttccom130602 tccom130  on tccom130.t$cadr = tdsls400.t$itad
INNER JOIN baandb.ttccom130602 tccom130c on tccom130c.t$cadr = tdsls400.t$stad
GROUP BY 
znsls400.t$ncia$c,
znsls401.t$pecl$c,
