...
--**********************************************************************************************************************************************************
    ...
    nvl((select dv.t$dqua$l from baandb.tcisli941602 dv
    ...
    (SELECT cisli943.t$amnt$l FROM baandb.tcisli943602 cisli943
	...
	cisli941.t$gexp$l-
		nvl((select sum(c.t$amnt$l) from baandb.tcisli941602 c
			...
			and   c.t$item$l=(select a.t$itjl$c 
							  from baandb.tznsls000602 a 
							  where a.t$indt$c=(select min(b.t$indt$c) from baandb.tznsls000602 b))),0) 
	...
	nvl(to_char((select cdv.t$docn$l from baandb.tcisli940602 cdv
  ...
  CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(cisli941.t$rcd_utc, 'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
	...
	(SELECT cisli943.t$sbas$l FROM baandb.tcisli943602 cisli943
		WHERE cisli943.t$fire$l=cisli941.t$fire$l
		AND cisli943.t$line$l=cisli941.t$line$l
...
FROM 
	...
	LEFT JOIN baandb.tcisli245602 cisli245															
				ON cisli245.t$fire$l=cisli941.t$fire$l
				AND cisli245.t$line$l=cisli941.t$line$l												

		LEFT JOIN baandb.tcisli943602 ICMS	ON 	ICMS.t$fire$l=cisli941.t$fire$l					
											AND	ICMS.t$line$l=cisli941.t$line$l
											AND ICMS.t$brty$l=1
		LEFT JOIN baandb.tcisli943602 COFINS ON COFINS.t$fire$l=cisli941.t$fire$l									
											AND	COFINS.t$line$l=cisli941.t$line$l
											AND COFINS.t$brty$l=6
		LEFT JOIN baandb.tcisli943602 PIS 	ON 	PIS.t$fire$l=cisli941.t$fire$l									
											AND	PIS.t$line$l=cisli941.t$line$l
											AND PIS.t$brty$l=5
		LEFT JOIN baandb.tcisli943602 CSLL 	ON 	CSLL.t$fire$l=cisli941.t$fire$l									
											AND	CSLL.t$line$l=cisli941.t$line$l
											AND CSLL.t$brty$l=13
                      
    LEFT JOIN baandb.tznsls401602 znsls401 ON cisli245.t$slso=znsls401.t$orno$c
                      AND cisli245.t$pono=znsls401.t$pono$c

    LEFT JOIN baandb.ttdsls401602 tdsls401 ON cisli245.t$slso=tdsls401.t$orno
