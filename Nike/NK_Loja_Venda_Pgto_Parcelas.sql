...
INNER JOIN BAANDB.TZNSLS402301 ZNSLS402		ON	ZNSLS402.T$NCIA$C	=	ZNSLS004.T$NCIA$C
...
INNER JOIN (SELECT	L.T$FIRE$L,
                    L.T$DVRF$C
			FROM BAANDB.TTDREC941301 L
			GROUP BY L.T$FIRE$L,
               L.T$DVRF$C) TDREC941		ON	TDREC941.T$FIRE$L = TDREC940.T$FIRE$L
			

INNER JOIN  BAANDB.TCISLI940301 CISLI940  ON CISLI940.T$FIRE$L = TDREC941.T$DVRF$C
...
INNER JOIN BAANDB.TZNSLS402301 ZNSLS402		ON	ZNSLS402.T$NCIA$C	=	ZNSLS400.T$NCIA$C
