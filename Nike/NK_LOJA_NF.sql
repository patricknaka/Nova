...
FROM  baandb.ttdrec940301  tdrec940
    ...
    LEFT JOIN baandb.ttccom130301 tccom130t         --transportadora
           ON tccom130t.t$cadr=tdrec940.t$cfra$l
           
    LEFT JOIN baandb.ttccom966301 tccom966r       
    ...
    LEFT JOIN baandb.ttdrec949301 tdrec949
...
SELECT DISTINCT
  ...
  ' '                       PIN,                                     --52
  'AGUARDANDO CONSULTOR'    DATA_REGISTRO_DPEC,                      --53
  cisli940.t$prot$l         PROTOCOLO_CANCELAMENTO_NFE,              --54
  'AGUARDANDO CONSULTOR'    DATA_CONTINGENCIA,                       --55
  'AGUARDANDO CONSULTOR'    JUSTIFICATIVA_CONTINGENCIA,              --56
  ' '                       OBS_INTERESSE_FISCO,                     --57
  '0'                       TRANSP_PF_PJ,                            --58
...
FROM  baandb.tcisli940301  cisli940
    ...
    LEFT JOIN baandb.ttccom130301 tccom130f           --filial emitente
           ON tccom130f.t$cadr=cisli940.t$sfra$l
           
    LEFT JOIN ( select  sum(a.t$dqua$l)  QTDE,
                        a.t$fire$l
                from    baandb.tcisli941301 a
                group by a.t$fire$l ) CISLI941
           ON CISLI941.t$fire$l=cisli940.t$fire$l
      
    LEFT JOIN baandb.ttccom100301 tccom100f
    ...
    LEFT JOIN baandb.ttccom966301 tccom966f       
    ...
    LEFT JOIN baandb.ttccom130301 tccom130entr
