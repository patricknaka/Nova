...
INNER JOIN BAANDB.TZNSLS402201 ZNSLS402		ON	ZNSLS402.T$NCIA$C	=	ZNSLS004.T$NCIA$C
...
INNER JOIN BAANDB.TZNSLS402201 ZNSLS402		ON	ZNSLS402.T$NCIA$C	=	ZNSLS400.T$NCIA$C
