...
INNER JOIN	BAANDB.TTDREC941201 TDREC941	ON	TDREC941.T$FIRE$L	=	TDREC947.T$FIRE$L
											AND	TDREC941.T$LINE$L	=	TDREC947.T$LINE$L
											
INNER JOIN	BAANDB.TTDREC940201 TDREC940	ON	TDREC940.T$FIRE$L	=	TDREC941.T$FIRE$L											

INNER JOIN	BAANDB.TZNSLS004201	ZNSLS004	ON	ZNSLS004.T$ORNO$C	=	TDREC947.T$ORNO$L
...
INNER JOIN	BAANDB.TTCIBD001201	TCIBD001	ON	TCIBD001.T$ITEM		=	TDREC941.T$ITEM$L
...
LEFT JOIN	BAANDB.TTCIBD004201	TCIBD004	ON	TCIBD004.T$CITT		=	'000'
 ...
 LEFT JOIN ( 	select 		whwmd217.t$item item,                             
				...
				left join baandb.twhinr140201 a                             
