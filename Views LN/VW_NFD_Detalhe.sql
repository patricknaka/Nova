SELECT DISTINCT
  ...
  CASE WHEN cisli941.t$insr$l+
            cisli941.t$gexp$l+
            cisli941.t$cchr$l>0 
  THEN nvl(ICMS.t$amnt$l, 0)-
  ...
  CASE WHEN (cisli941.t$sour$l=2 or cisli941.t$sour$l=8) 
    THEN cisli941.t$gexp$l
  ...
  CASE WHEN cisli940.t$fdty$l=15 
    then cisli941.t$refr$l
    ELSE NULL END                                       NR_REFERENCIA_FISCAL_FATURA,

  CASE WHEN cisli940.t$fdty$l=15 
    then TO_CHAR(cisli941.t$rfdl$l)
