...
-- FAF.301 - Fabio Ferreira, 03-jul-2014, Fabio Ferreira, 	Inclusão do numero da linha da ordem para adicionar na chave e evitar duplicidade
...
-- #HMK.001 - 14-aug-2015, Humberto Kasai, Correção para registros duplicados na znsls401.
--***************************************************************************************************************************************************************
--SELECT DISTINCT   --#HMK.001.o
SELECT              --#HMK.001.n
...
--          znsls401.t$vldi$c                                         VL_DESCONTO_INCONDICIONAL,      --#HMK.0001.o
          znsls401.TOT_VLDI                                           VL_DESCONTO_INCONDICIONAL,      --#HMK.001.n
--          znsls401.t$vlfr$c                                         VL_FRETE_CLIENTE,               --#HMK.001.o
          znsls401.TOT_VLFR                                           VL_FRETE_CLIENTE,               --#HMK.001.n
          nvl((select sum(f.t$vlft$c) from baandb.tznfmd630301 f
...
--          znsls401.t$vlde$c                                           VL_DESPESA_ACESSORIO,         --#HMK.001.o
          znsls401.TOT_VLDE                                            VL_DESPESA_ACESSORIO,          --#HMK.001.n
          -- znsls400.t$vldf$c VL_JUROS,																					--#FAF.317.o
--		  cast((((znsls401.t$vlun$c*znsls401.t$qtve$c)+znsls401.t$vlfr$c-znsls401.t$vldi$c+znsls401.t$vlde$c) --#HMK.001.o
        cast((((znsls401.t$vlun$c*znsls401.TOT_QTVE)+znsls401.TOT_VLFR-znsls401.TOT_VLDI+znsls401.TOT_VLDE) --#HMK.001.n
				/sls401p.VL_PGTO_PED)*znsls402.t$vlju$c as numeric(12,2))      VL_JUROS,											--#FAF.317.n

--		  cast((znsls401.t$vlun$c*znsls401.t$qtve$c)+znsls401.t$vlfr$c-znsls401.t$vldi$c+znsls401.t$vlde$c+   --#HMK.001.o
		    cast((znsls401.t$vlun$c*znsls401.TOT_QTVE)+znsls401.TOT_VLFR-znsls401.TOT_VLDI+znsls401.TOT_VLDE+   --#HMK.001.n
--		  (((znsls401.t$vlun$c*znsls401.t$qtve$c)+znsls401.t$vlfr$c-znsls401.t$vldi$c+znsls401.t$vlde$c)      --#HMK.001.o
		    (((znsls401.t$vlun$c*znsls401.TOT_QTVE)+znsls401.TOT_VLFR-znsls401.TOT_VLDI+znsls401.TOT_VLDE)      --#HMK.001.n
	  ...
	  (select min(cisli940.t$stat$l) 
	   from baandb.tcisli940301 cisli940, baandb.tcisli245301 cisli245
...
--	case when znsls401.t$qtve$c<0 then 2 else 1 end                       IN_CANCELADO			--#FAF.313.n    --#HMK.001.o
  case when znsls401.TOT_QTVE<0 then 2 else 1 end                       IN_CANCELADO			--#FAF.313.n    --#HMK.001.o
  
FROM
        baandb.ttdsls401301 tdsls401,
--        baandb.tznsls401301 znsls401                          --#HMK.001.o
		    ( select  a.t$ncia$c,                                   --#HMK.001.sn
                  a.t$uneg$c,
                  a.t$pecl$c,
                  a.t$sqpd$c,
                  a.t$entr$c,
          ...
          group by  a.t$ncia$c,
                    ...
                    a.t$vlun$c,
                    a.t$tpcb$c,
                    a.t$igar$c ) znsls401,                    --#HMK.001.en
          
          baandb.tznsls004301 znsls004,
          
--				LEFT JOIN baandb.tznsls004301 znsls004 													--#FAF.174.sn   --#HMK.001.so
...
--										AND znsls004.t$pono$c=znsls401.t$pono$c,					--#FAF.174.en		  --#HMK.001.eo				
		...
		from baandb.tznsls401301 znsls401t
		group by
			znsls401t.t$ncia$c,																				
			znsls401t.t$uneg$c,
			znsls401t.t$pecl$c,
		...
		(select	sum(znsls402t.t$vlju$c) t$vlju$c,
				...
				znsls402t.t$pecl$c,
        znsls402t.t$sqpd$c
		from baandb.tznsls402301 znsls402t
		group by
				znsls402t.t$ncia$c,
				znsls402t.t$uneg$c,
				znsls402t.t$pecl$c,
...
and     znsls004.t$ncia$c=znsls401.t$ncia$c                                     --#HMK.sn
and    znsls004.t$uneg$c=znsls401.t$uneg$c
and     znsls004.t$pecl$c=znsls401.t$pecl$c			
and     znsls004.t$orno$c=znsls401.t$orno$c  						
and     znsls004.t$pono$c=znsls401.t$pono$c                                     --#HMK.en
and     tdsls401.t$sqnb = 0                       --#HMK.n - Correção para não contemplar entregas parciais
