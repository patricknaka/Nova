...
-- 11/12/2015 - Humberto Kasai - Correção duplicidade e reorganização dos joins
--***************************************************************************************************************************************************************
SELECT DISTINCT
    ...
    AT time zone 'America/Sao_Paulo') AS DATE) DT_ENTREGA,
          ...
          tdsls401.VL_TOT   VL_ITEM,																		--#FAF.123.n
        ...
        CASE WHEN znsls402.t$vlju$c IS NULL THEN
              cast(0.0 as numeric(12,2))
        ELSE
          cast((((znsls401.t$vlun$c*znsls401.t$qtve$c)+znsls401.t$vlfr$c-znsls401.t$vldi$c+znsls401.t$vlde$c) 
          /sls401p.VL_PGTO_PED)*znsls402.t$vlju$c as numeric(12,2)) 
        END 
      end     VL_JUROS,
      
        CASE WHEN ZNSLS402.t$vlju$c IS NULL OR sls401p.VL_PGTO_PED = 0 THEN
          cast((znsls401.t$vlun$c*znsls401.t$qtve$c)+znsls401.t$vlfr$c-znsls401.t$vldi$c+znsls401.t$vlde$c as numeric(18,2))
        ELSE
          cast((znsls401.t$vlun$c*znsls401.t$qtve$c)+znsls401.t$vlfr$c-znsls401.t$vldi$c+znsls401.t$vlde$c+   
          (((znsls401.t$vlun$c*znsls401.t$qtve$c)+znsls401.t$vlfr$c-znsls401.t$vldi$c+znsls401.t$vlde$c)      
          /sls401p.VL_PGTO_PED)*znsls402.t$vlju$c as numeric(18,2)) END     VL_TOTAL_ITEM,														
	  ...
	  cisli940.t$stat$l  CD_SITUACAO_NF,										--#FAF.129.n
...
INNER JOIN (select distinct 																									--#FAF.317.sn
        ...
        ON	  sls401p.t$ncia$c = znsls401.t$ncia$c															--#FAF.317.sn
