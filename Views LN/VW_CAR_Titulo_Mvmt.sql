...
--	nvl(r.t$lino, tfacr200.t$lino) SQ_MOVIMENTO,													

		--#FAF.186.1.n	--#FAF.186.2.o
...
--	tfacr200.t$doct$l COD_DOCUMENTO,														
	...
	tfacr200.t$amnt VL_TRANSACAO,															
				...
				--#FAF.186.o	--#FAF.186.2.n
--	nvl(r.t$amnt*-1, tfacr200.t$amnt)  VL_TRANSACAO,												

		--#FAF.186.n	--#FAF.186.2.o
	...
	--#FAF.079.n
	CASE WHEN t.t$balc=t.t$bala															

-- Liquidado	--#FAF.079.sn
	...
	WHEN t.t$balc=t.t$amnt																

-- Nenhum recebimento
	THEN tfacr200.t$docd
	ELSE (select min(t$docd) from baandb.ttfacr200201 m										-- 

Primeiro rec parcial 
	 where m.t$ttyp=tfacr200.t$ttyp
	 and m.t$ninv=tfacr200.t$ninv 
	 and m.t$schn=tfacr200.t$schn)
	...
	nvl((select znacr005.t$ttyp$c || znacr005.t$ninv$c from BAANDB.tznacr005201 znacr005				--#FAF.002.sn
		 ...
		 and znacr005.T$FLAG$C=1														
				...
				--#FAF.007.n
		 and rownum=1), 
		 (select rs.t$ttyp || rs.t$ninv from baandb.ttfacr200201 rs										
...
--	tfacr200.t$doct$l COD_DOCUMENTO,														
				...
				--#FAF.102.o	--#FAF.186.1.o
--	tfacr200.t$doct$l CD_TRANSACAO_DOCUMENTO,													

			--#FAF.186.1.o
--	tfacr200.t$tdoc CD_TRANSACAO_TITULO,
	--tfacr200.t$dim1 NUM_CONTA															
	...
	tfacr201.t$liqd DT_LIQUIDEZ_PREVISTA,														
				...
				--#FAF.186.1.en
	CASE WHEN tfacr200.t$tdoc='ENC' THEN 5														

				--#FAF.213.n
	WHEN (select a.t$catg from baandb.ttfgld011201 a where a.t$ttyp=tfacr200.t$tdoc)=10 THEN 3							
...
--								rs.t$lino, rs.t$amnt									
					...
					--#FAF.186.1.n	--#FAF.186.2.so
--				from ttfacr200201 rs) r													

					--#FAF.002.sn		
--	ON r.t$tdoc=tfacr200.t$tdoc 
--	and r.t$docn=tfacr200.t$docn
--	and r.t$ttyp!=tfacr200.t$ttyp
--	and r.t$ninv!=tfacr200.t$ninv															

				--#FAF.002.en	--#FAF.186.2.eo
	
--	LEFT JOIN (select a.t$ttyp, a.t$ninv, a.t$brel FROM ttfacr201201 a										

--#FAF.001.sn	--#FAF.186.1.so
--	where a.t$brel!=' '
