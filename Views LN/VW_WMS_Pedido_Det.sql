...
--											Correção quantidade cancelada
--*******************************************************************************************************************************************
SELECT
	ORDERDETAIL.orderkey COD_PEDIDO_WMS, ORDERDETAIL.WHSEID ARMAZEM,
	ORDERDETAIL.sku COD_ITEM,
	ORDERDETAIL.ORDERLINENUMBER SEQUENCIA_PEDIDO,
	ORDERDETAIL.lot COD_LOTE,
	ORDERDETAIL.ORIGINALQTY QUANTIDADE_PEDIDA,
	ORDERDETAIL.ORIGINALQTY-ORDERDETAIL.OPENQTY QUANTIDADE_ATENDIDA,
	ORDERDETAIL.STATUS SITUACAO_ITEM,	
	ORDERDETAIL.SHIPPEDQTY QUANTIDADE_LIQUIDADA,									
  ...
  and orderstatushistory.STATUS=ORDERDETAIL.STATUS), ORDERDETAIL.ADDDATE) DATA_SITUACAO_ITEM,
	CASE WHEN ORDERDETAIL.ADJUSTEDQTY!=0 THEN ORDERDETAIL.ORIGINALQTY-ORDERDETAIL.ADJUSTEDQTY 
	ELSE 0 
	END QUANTIDADE_CANCELADA,
	ORDERDETAIL.editdate DT_HR_ATUALIZACAO
