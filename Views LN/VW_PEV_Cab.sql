 select tdsls400.t$rcd_utc                              DT_ULT_ATUALIZACAO,         --Capa Ordem de Venda LN - Data [Ult. Atualizacao
        ...
        group by o.t$orno )                             CD_NATUREZA_OPERACAO,       --#FAF.177.n
        ...
        CASE WHEN tdsls094.t$bill$c !=  3 
             ...
             ELSE   '0' 
        END                                             NR_NF_CONSOLIDADA,          --#MAR.304.n      
        CASE WHEN tdsls094.t$bill$c !=  3 
               THEN consold.SERIE 
             ELSE   ' ' 
