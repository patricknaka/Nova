select  RTRIM(LTRIM(ipu001.t$item)) CD_ITEM, 
    ...
    from    BAANDB.ttdipu001201 ipu001, --DADOS DE COMPRA DOS ITENS
            BAANDB.ttcibd001201 ibd001, --DADOS GERAIS DOS ITENS
            BAANDB.tznisa002201 isa002  --DADOS DE VENDA DOS ITENS
