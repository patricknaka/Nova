...
INNER JOIN baandb.tcisli941201 cisli941f --#FAF.169.n
...
LEFT JOIN baandb.tcisli943201 ICMS	
       ON ICMS.t$fire$l = cisli941f.t$fire$l	--#FAF.201.sn
...
LEFT JOIN (select znsls402q.t$ncia$c,
         ...
         ON znsls402.t$ncia$c = znsls401.t$ncia$c	--#FAF.180.sn
...
INNER JOIN baandb.ttdsls400201 tdsls400       --#FAF.087.sn
        ON tdsls400.t$orno = tdsls401.t$orno  --#FAF.087.n
...
LEFT JOIN ( select c245.T$SLSO, c940.T$DOCN$L NOTA, c940.t$seri$l SERIE
       ...
       ON consold.T$SLSO = tdsls400.t$orno  --#FAF.087.en
