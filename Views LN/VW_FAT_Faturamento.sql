SELECT
  ...
  CASE WHEN (	SELECT tcemm030.t$euca FROM baandb.ttcemm124301 tcemm124, baandb.ttcemm030301 tcemm030	--#FAF.303.1.sn
...
ELSE (	SELECT tcemm030.t$euca FROM baandb.ttcemm124301 tcemm124, baandb.ttcemm030301 tcemm030
  ...
  CASE WHEN cisli940.t$fdty$l=15 then (select distinct a.t$docn$l from baandb.tcisli940301 a, baandb.tcisli941301 b
                                                                where b.t$fire$l=cisli940.t$fire$l
                                                                and a.t$fire$l=b.t$refr$l and rownum=1) else 0
  end NR_NF_FATURA,
  CASE WHEN cisli940.t$fdty$l=15 then (select distinct a.t$seri$l from baandb.tcisli940301 a, baandb.tcisli941301 b
                                                                  where b.t$fire$l=cisli940.t$fire$l
                                                                  and a.t$fire$l=b.t$refr$l and rownum=1) else ' '
  end NR_SERIE_NF_FATURA,
  CASE WHEN cisli940.t$fdty$l=16 then (select distinct a.t$docn$l from baandb.tcisli940301 a, baandb.tcisli941301 b
                                                                  where b.t$fire$l=cisli940.t$fire$l and a.t$fire$l=b.t$refr$l and rownum=1) else 0
  end NR_NF_REMESSA,
  CASE WHEN cisli940.t$fdty$l=16 then (select distinct a.t$seri$l from baandb.tcisli940301 a, baandb.tcisli941301 b 
                                                                  where b.t$fire$l=cisli940.t$fire$l
                                                                  and a.t$fire$l=b.t$refr$l and rownum=1) else ' '
  ...
  (Select CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(max(brnfe020.t$date$l), 'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
   ...
   FROM baandb.tbrnfe020301 brnfe020
   Where brnfe020.t$refi$l=cisli940.t$fire$l AND brnfe020.t$ncmp$l=301) 
  AS DT_STATUS,
  cisli940.t$fdty$l CD_TIPO_NF,
  ltrim(rtrim(cisli941f.t$item$l)) CD_ITEM,
  cisli941f.t$dqua$l QT_FATURADA,
  nvl(ICMS.t$amnt$l, 0) VL_ICMS,	--#FAF.301.n
  Nvl((SELECT cisli943.t$amnt$l from baandb.tcisli943301 cisli943 WHERE cisli943.t$fire$l=cisli941f.t$fire$l
  ...
  TRUNC(case when cisli941.t$item$l not in	
    ...
    and c.t$item$l=(select a.t$itmd$c
                    from baandb.tznsls000301 a
                    where a.t$indt$c=(select min(b.t$indt$c) from baandb.tznsls000301 b))),0)* (cisli941.t$gamt$l/cisli940.t$gamt$l)
                    else 0 end
                    else 0 end,2) 
  AS VL_DESPESA,
  ...
  cisli941f.t$fght$l*(nvl(ICMS.t$rate$l,0)/100) VL_ICMS_FRETE,
    CASE WHEN cisli941f.t$insr$l+cisli941f.t$gexp$l+cisli941f.t$cchr$l>0 THEN	--#FAF.301.sn
    nvl(ICMS.t$amnt$l, 0)	  -cisli941f.t$iprt$l*(nvl(ICMS.t$rate$l,0)/100) -cisli941f.t$fght$l*(nvl(ICMS.t$rate$l,0)/100)
    ELSE 0 END	
  AS VL_ICMS_OUTROS,	
  nvl(COFINS.t$amnt$l,0) VL_COFINS,	--#FAF.301.n
  cisli941f.t$iprt$l*(nvl(COFINS.t$rate$l,0)/100) VL_COFINS_PRODUTO, --#FAF.301.n
  cisli941f.t$fght$l*(nvl(COFINS.t$rate$l,0)/100) VL_COFINS_FRETE, --#FAF.301.n
    CASE WHEN cisli941f.t$insr$l+cisli941f.t$gexp$l+cisli941f.t$cchr$l>0 THEN	--#FAF.301.sn
    ...
    cisli941f.t$iprt$l*(nvl(PIS.t$rate$l,0)/100) VL_PIS_PRODUTO,	--#FAF.301.n
    cisli941f.t$fght$l*(nvl(PIS.t$rate$l,0)/100) VL_PIS_FRETE,	--#FAF.301.n
  ...
  cisli941f.t$iprt$l*(nvl(CSLL.t$rate$l,0)/100) VL_CSLL_PRODUTO,	--#FAF.301.n
  cisli941f.t$fght$l*(nvl(CSLL.t$rate$l,0)/100) VL_CSLL_FRETE,	--#FAF.301.n
    ...
    ELSE 0 END	VL_CSLL_OUTROS, --#FAF.301.en
  ...
  nvl((select sum(b.t$mauc$1) from baandb.twhina114301 a, baandb.twhina113301 b
  ...
  Nvl((SELECT cisli943.t$base$l from baandb.tcisli943301 cisli943
       WHERE cisli943.t$fire$l=cisli941f.t$fire$l
       AND cisli943.t$line$l=cisli941f.t$line$l
       AND cisli943.t$brty$l=3),0) VL_BASE_IPI,
       nvl((select t.t$suno from baandb.ttcmcs080301 t where t.t$cfrw=cisli940.t$cfrw$l and rownum=1),' ') 
  ...
  AS DT_ENTREGA,
    (Select sum(znfmd630.t$qvol$c) From baandb.tznfmd630301 znfmd630 WHERE znfmd630.t$fire$c=cisli941f.t$fire$l and rownum=1) 
  AS QT_VOLUME,
  ...
  AS CD_UNIDADE_EMPRESARIAL,
    (select CASE WHEN regexp_replace(e.t$fovn$l, '[^0-9]', '') IS NULL
            ...
            from baandb.ttccom130301 e where e.t$cadr=cisli940.t$stoa$l and rownum=1) 
  AS NR_CNPJ_CPF_ENTREGA,
    (select e.t$ftyp$l from baandb.ttccom130301 e where e.t$cadr=cisli940.t$stoa$l and rownum=1) 
  AS CD_TIPO_CLIENTE_ENTREGA,
    (select CASE WHEN regexp_replace(e.t$fovn$l, '[^0-9]', '') IS NULL
            ...
            THEN '00000000000000'
            ELSE regexp_replace(e.t$fovn$l, '[^0-9]', '') END --#FAF.151.n
            from baandb.ttccom130301 e where e.t$cadr=cisli940.t$itoa$l and rownum=1) 
  AS NR_CNPJ_CPF_FATURA,
    (select e.t$ftyp$l from baandb.ttccom130301 e where e.t$cadr=cisli940.t$itoa$l and rownum=1) 
...
FROM baandb.tcisli940301 cisli940,
     ...
     baandb.tcisli941301 cisli941f --#FAF.169.n
LEFT JOIN baandb.tcisli943301 ICMS	ON ICMS.t$fire$l=cisli941f.t$fire$l	--#FAF.301.sn
     AND	ICMS.t$line$l=cisli941f.t$line$l
     AND ICMS.t$brty$l=1
LEFT JOIN baandb.tcisli943301 COFINS ON COFINS.t$fire$l=cisli941f.t$fire$l	
     AND	COFINS.t$line$l=cisli941f.t$line$l
     AND COFINS.t$brty$l=6
LEFT JOIN baandb.tcisli943301 PIS ON PIS.t$fire$l=cisli941f.t$fire$l	
     AND	PIS.t$line$l=cisli941f.t$line$l
     AND PIS.t$brty$l=5
LEFT JOIN baandb.tcisli943301 CSLL ON CSLL.t$fire$l=cisli941f.t$fire$l	
     AND	CSLL.t$line$l=cisli941f.t$line$l
     AND CSLL.t$brty$l=13,
baandb.tcisli245301 cisli245,
baandb.ttdsls401301 tdsls401,
baandb.tznsls004301 znsls004,	--Origem OV
...
(select 
 ...
 from	baandb.tznsls402301 znsls402q
  group by
    znsls402q.t$ncia$c,
    znsls402q.t$uneg$c,
    znsls402q.t$pecl$c,
    znsls402q.t$sqpd$c) znsls402,	--#FAF.301.en
baandb.ttdsls400301 tdsls400 --#FAF.087.sn
LEFT JOIN ( select c245.T$SLSO, c940.T$DOCN$L NOTA, c940.t$seri$l SERIE
            from baandb.tcisli245301 c245
            inner join baandb.tcisli941301 c941 on c941.t$fire$l=c245.T$FIRE$L   
...
baandb.ttccom130301 endfat,
baandb.ttccom130301 endent,
baandb.ttcibd001301 tcibd001,
baandb.ttdsls094301 tdsls094 --#FAF.087.n
