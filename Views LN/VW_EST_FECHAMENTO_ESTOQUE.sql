		...
		WHERE 
			...
			whina113.t$seqn=( SELECT												
							  ...
							  WHERE 
								  ...
								  whina112a.t$trdt = whina113.t$trdt) 
			AND tcemm030q.t$euca=tcemm030.t$euca
			AND tcemm112q.t$grid=tcemm112.t$grid
			AND whina112.t$item=whwmd215.t$item
		GROUP BY
			whina112.t$item, tcemm030q.t$euca, tcemm112q.t$grid) VL_CMV
