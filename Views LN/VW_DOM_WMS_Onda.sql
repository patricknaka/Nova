...
--*******************************************************************************************************************************************
SELECT
	WAVE.WAVEKEY COD_ONDA, WAVE.WHSEID ARMAZEM,
	' ' COD_PROGRAMA  ,                              			-- *** AGAURDANDO DUVIDA *** 
	CAST((FROM_TZ(CAST(TO_CHAR(WAVE.ADDDATE , 'DD-MON-YYYY HH:MI:SS AM') AS TIMESTAMP), 'GMT')
	...
	CAST((FROM_TZ(CAST(TO_CHAR(WAVE.EDITDATE , 'DD-MON-YYYY HH:MI:SS AM') AS TIMESTAMP), 'GMT')
