...
SELECT
		...
		0														DESCONTO,
		0														QTDE_TOTAL,
		(TDREC940.T$GTAM$L + TDREC940.T$GEXP$L)*-1				                    VALOR_TIKET,
		(TDREC940.T$GTAM$L + TDREC940.T$GEXP$L + TDREC940.T$FGHT$L)*-1				VALOR_PAGO,
		(TDREC940.T$GTAM$L + TDREC940.T$GEXP$L)*-1				                    VALOR_VENDA_BRUTA,
		(TDREC940.T$GTAM$L + TDREC940.T$GEXP$L)                               VALOR_TROCA,
