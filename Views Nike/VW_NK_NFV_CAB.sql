...
--**********************************************************************************************************************************************************
    ...
    CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(cisli940.t$date$l, 'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
		...
		(SELECT cisli942.t$amnt$l FROM baandb.tcisli942601 cisli942
		...
		(SELECT sum(cisli941.t$ldam$l) FROM baandb.tcisli941601 cisli941
		WHERE cisli941.t$fire$l=cisli940.t$fire$l) VL_DESCONTO,
		cisli940.t$amnt$l VL_TOTAL_NF,
        CASE WHEN cisli940.t$fdty$l=15 then
          (select a.t$docn$l from baandb.tcisli940601 a, baandb.tcisli941601 b
       ...
       CASE WHEN cisli940.t$fdty$l=15 then
          (select a.t$seri$l from baandb.tcisli940601 a, baandb.tcisli941601 b
          where b.t$fire$l=cisli940.t$fire$l
          and a.t$fire$l=b.t$refr$l
          and rownum=1
          group by a.t$seri$l)
        ...
        Nvl((SELECT sum(cisli943.t$amnt$l) from baandb.tcisli943601 cisli943
		...
		nvl((select sum(l.t$gexp$l) from baandb.tcisli941601 l
		where	l.t$fire$l = cisli940.t$fire$l
		and (l.t$sour$l=2 or l.t$sour$l=8)),0) VL_ADICIONAL_IMPORTACAO,
		nvl((select sum(li.t$amnt$l) from baandb.tcisli943601 li, baandb.tcisli941601 l
		where	l.t$fire$l = cisli940.t$fire$l
		...
		nvl((select sum(l.t$fght$l) from baandb.tcisli941601 l
		where	l.t$fire$l = cisli940.t$fire$l
	...
	nvl((select CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(max(c1.t$rcd_utc), 'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
			AT time zone 'America/Sao_Paulo') AS DATE) from baandb.tcisli941601 c1 
	...
	nvl((select CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(max(c2.t$rcd_utc), 'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
			AT time zone 'America/Sao_Paulo') AS DATE) from baandb.tcisli943601 c2 
