...
--**********************************************************************************************************************************************************
  601 CD_CIA,
	...
	AND rownum=1) = ' ' THEN SUBSTR((SELECT tcemm124.t$grid FROM baandb.ttcemm124601 tcemm124, baandb.ttcemm030601 tcemm030
	WHERE tcemm124.t$cwoc=tdrec940.t$cofc$l
	AND tcemm124.t$loco=601 AND rownum=1),5,2) ELSE (SELECT tcemm030.t$euca FROM baandb.ttcemm124601 tcemm124, baandb.ttcemm030601 tcemm030
	WHERE tcemm124.t$cwoc=tdrec940.t$cofc$l
	AND tcemm030.t$eunt=tcemm124.t$grid
	AND tcemm124.t$loco=601
	...
	(Select a.t$fire$l from baandb.ttdrec944601 a, baandb.ttdrec940601 b
	...
	(SELECT tdrec949.t$base$l FROM baandb.ttdrec949601 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	AND tdrec949.t$brty$l=1) VL_BASE_ICMS,
	(SELECT tdrec949.t$amnt$l FROM baandb.ttdrec949601 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	AND tdrec949.t$brty$l=1) VL_ICMS,
	(SELECT tdrec949.t$amnt$l FROM baandb.ttdrec949601 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	AND tdrec949.t$brty$l=2) VL_ICMS_ST,
	(SELECT sum(tdrec942.t$amnr$l) FROM baandb.ttdrec942601 tdrec942
...
--			where a.t$fire$l=tdrec941.t$fire$l																--#FAF.094.o
	...
	nvl((select t.t$text from baandb.ttttxt010601 t 
	where t$clan='p'
	...
	nvl((SELECT tdrec949.t$amnt$l FROM baandb.ttdrec949601 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	...
	nvl((select sum(l.t$gexp$l) from baandb.ttdrec941601 l
		where	l.t$fire$l = tdrec940.t$fire$l
		and (l.t$sour$l=2 or l.t$sour$l=8)),0) VL_ADICIONAL_IMPORTACAO,
	nvl((select sum(li.t$amnt$l) from baandb.ttdrec942601 li, baandb.ttdrec941601 l
		where	l.t$fire$l = tdrec940.t$fire$l
	...
	/*nvl((select sum(l.t$fght$l) from baandb.ttdrec941601 l
		where	l.t$fire$l = tdrec940.t$fire$l
		and l.t$crpd$l = 1),0)*/ 
    CAST(nvl((select sum(l.t$fght$l) from baandb.ttdrec941601 l
		where	l.t$fire$l = tdrec940.t$fire$l
		and l.t$crpd$l = 1),0) as numeric (18,2)) VL_CIF,
	nvl((select lr.t$mdev$c from baandb.twhinh312601 lr, baandb.ttdrec947601 rf
	...
	nvl((Select max(d.t$crpd$l) from baandb.ttdrec941601 d
	where d.t$fire$l=tdrec940.t$fire$l),2) CD_TIPO_FRETE,																
	nvl((SELECT tdrec949.t$isco$c FROM baandb.ttdrec949601 tdrec949
	WHERE tdrec949.t$fire$l=tdrec940.t$fire$l
	...
	WHERE tcemm124.t$cwoc=tdrec940.t$cofc$l
	AND tcemm124.t$loco=601 AND rownum=1) CD_UNIDADE_EMPRESARIAL,
	tdrec940.t$fire$l NR_REFERENCIA_FISCAL,
	nvl((select ca.t$recd$c from baandb.twhinh300601 ca														--#FAF.199.n
...
FROM
	...
	LEFT JOIN baandb.ttccom966601 tccom966 ON tccom966.t$comp$d=tdrec940.t$fovn$l
	LEFT JOIN baandb.ttdrec940601 tdrec940r ON tdrec940r.t$fire$l=tdrec940.t$rref$l
	...
	LEFT JOIN baandb.tcisli940601 cisli940 	ON cisli940.t$fire$l = REFDEV.rfdv
