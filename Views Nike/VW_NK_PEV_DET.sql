...
--        AT time zone 'America/Sao_Paulo') AS DATE) DT_ENTREGA,
      ...
      CASE WHEN tdsls401.t$clyn = 1 THEN 35 -- cancelado
        ...
        ELSE
          ...
          /sls401p.VL_PGTO_PED)*znsls402.t$vlju$c as numeric(12,2)) END VL_JUROS,
          
        CASE WHEN ZNSLS402.t$vlju$c IS NULL THEN
          cast((znsls401.t$vlun$c*znsls401.TOT_QTVE)+znsls401.TOT_VLFR-znsls401.TOT_VLDI+znsls401.TOT_VLDE as numeric(18,2))
        ELSE
          cast((znsls401.t$vlun$c*znsls401.TOT_QTVE)+znsls401.TOT_VLFR-znsls401.TOT_VLDI+znsls401.TOT_VLDE+   
