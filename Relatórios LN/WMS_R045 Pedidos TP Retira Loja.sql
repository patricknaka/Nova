...
FROM       BAANDB.TTDSLS400201@DLN01 TDSLS400                                     
INNER JOIN (select a.t$ncia$c,                                                    
                   ...
                   a.t$entr$c,
                   a.t$orno$c                                                     
              from BAANDB.TZNSLS004201@DLN01 a                                    
          group by a.t$ncia$c,                                                    
                   a.t$uneg$c,                                                    
                   a.t$pecl$c,                                                    
                   a.t$sqpd$c,
...
INNER JOIN BAANDB.TZNSLS400201@DLN01 ZNSLS400                                     
...
INNER JOIN BAANDB.TZNSLS401201@DLN01 ZNSLS401                                     
...
INNER JOIN BAANDB.TZNSLS002201@DLN01 ZNSLS002
		ON ZNSLS002.T$TPEN$C = ZNSLS401.T$ITPE$C
	   
	   
INNER JOIN BAANDB.TTCCOM100201@DLN01 TCCOM100                                     
...
INNER JOIN (select a.t$ncia$c,                                                    
       ...
       (dense_rank last order by a.t$dtoc$c, a.t$seqn$c) PONTO,                   
        ...
        inner join BAANDB.TZNMCS002201@DLN01 b                                    
