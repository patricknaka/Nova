SELECT DISTINCT 
  ...
  CASE WHEN regexp_replace(tccom130t.t$fovn$l, '[^0-9]', '') IS NULL
    ...
    THEN '00000000000000'
    ELSE regexp_replace(tccom130t.t$fovn$l, '[^0-9]', '') END CNPJ_TRANSPORTADORA,
...
INNER JOIN baandb.ttdsls400301  tdsls400  ON  tdsls400.t$orno = znfmd630.t$orno$c
...
INNER JOIN (select a1.t$ncia$c,
			...
			group by a1.t$ncia$c,
			         ...
			         a1.t$sqpd$c,
			         a1.t$entr$c,
					 a1.t$orno$c) znsls004		ON znsls004.t$orno$c = znfmd630.t$orno$c
