select
        ...
        tdrec955.t$fire$l                       REFERENCIA_FAT_ORIGEM,
        tdrec955.t$line$l                       LINHA,
        tdrec955.t$sern$l                       SEQ,
        cisli940.t$docn$l                       DOC_ORIGEM,
        cisli940.t$seri$l                       SERIE,
        tdrec955.t$fdtc$l                       TIPO_DOC,
        TIPO_DOC_O.DESCR                        TIPO_DOC_FISCAL,
        ORIG_TRANS.DESCR                        ORIGEM_TRANSACAO,
        ORD_DEV.t$lfir$l                        REFERENCIA_RECEBIMENTO,
        ORD_DEV.t$llin$l                        LINHA,
        ORD_DEV.t$ser2$l                        SEQ,
        tdrec940.t$docn$l                       DOC_FORNECEDOR,
        tdrec940.t$seri$l                       SERIE,
        TIPO_DOC_D.DESCR                        TIPO_DOC_FISCAL,
