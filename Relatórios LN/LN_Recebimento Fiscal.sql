CREATE VIEW VW_RPT_SPL_RECEBIMENTO_FISCAL AS
...
INNER JOIN ( select a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
                    a.TYPE,
                    a.WHSEID
               from WMWHSE1.RECEIPT@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
                    a.TYPE,
                    a.WHSEID ) WMS_RECEIPT
...
INNER JOIN ( select a.RECEIPTKEY,
               ...
               from WMWHSE1.RECEIPTDETAIL@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
...
INNER JOIN ( select a.RECEIPTKEY,
                    ...
                    a.TYPE,
                    a.WHSEID
               from WMWHSE2.RECEIPT@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
...
INNER JOIN ( select a.RECEIPTKEY,
                    a.SKU,
                    sum(a.QTYRECEIVED) QTDE
               from WMWHSE2.RECEIPTDETAIL@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.SKU ) WMS_REC_DETAIL
        ON WMS_REC_DETAIL.RECEIPTKEY = WMS_RECEIPT.RECEIPTKEY
...
INNER JOIN ( select a.RECEIPTKEY,
                    ...
                    a.TYPE,
                    a.WHSEID
               from WMWHSE3.RECEIPT@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
...
INNER JOIN ( select a.RECEIPTKEY,
                    a.SKU,
                    sum(a.QTYRECEIVED) QTDE
               from WMWHSE3.RECEIPTDETAIL@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.SKU ) WMS_REC_DETAIL
        ON WMS_REC_DETAIL.RECEIPTKEY = WMS_RECEIPT.RECEIPTKEY
...
INNER JOIN ( select a.RECEIPTKEY,
                    ...
                    a.TYPE,
                    a.WHSEID
               from WMWHSE4.RECEIPT@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
...
INNER JOIN ( select a.RECEIPTKEY,
                    a.SKU,
                    sum(a.QTYRECEIVED) QTDE
               from WMWHSE4.RECEIPTDETAIL@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.SKU ) WMS_REC_DETAIL
        ON WMS_REC_DETAIL.RECEIPTKEY = WMS_RECEIPT.RECEIPTKEY
...
INNER JOIN ( select a.RECEIPTKEY,
                    ...
                    a.TYPE,
                    a.WHSEID
               from WMWHSE5.RECEIPT@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
...
INNER JOIN ( select a.RECEIPTKEY,
                    a.SKU,
                    sum(a.QTYRECEIVED) QTDE
               from WMWHSE5.RECEIPTDETAIL@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.SKU ) WMS_REC_DETAIL
        ON WMS_REC_DETAIL.RECEIPTKEY = WMS_RECEIPT.RECEIPTKEY
...
INNER JOIN ( select a.RECEIPTKEY,
                    ...
                    a.TYPE,
                    a.WHSEID
               from WMWHSE6.RECEIPT@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
...
INNER JOIN ( select a.RECEIPTKEY,
                    a.SKU,
                    sum(a.QTYRECEIVED) QTDE
               from WMWHSE6.RECEIPTDETAIL@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.SKU ) WMS_REC_DETAIL
        ON WMS_REC_DETAIL.RECEIPTKEY = WMS_RECEIPT.RECEIPTKEY
...
INNER JOIN ( select a.RECEIPTKEY,
                    ...
                    a.TYPE,
                    a.WHSEID
               from WMWHSE7.RECEIPT@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
...
INNER JOIN ( select a.RECEIPTKEY,
                    a.SKU,
                    sum(a.QTYRECEIVED) QTDE
               from WMWHSE7.RECEIPTDETAIL@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.SKU ) WMS_REC_DETAIL
        ON WMS_REC_DETAIL.RECEIPTKEY = WMS_RECEIPT.RECEIPTKEY
...
INNER JOIN ( select a.RECEIPTKEY,
                    ...
                    a.TYPE,
                    a.WHSEID
               from WMWHSE11.RECEIPT@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
...
INNER JOIN ( select a.RECEIPTKEY,
                    a.SKU,
                    sum(a.QTYRECEIVED) QTDE
               from WMWHSE11.RECEIPTDETAIL@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.SKU ) WMS_REC_DETAIL
        ON WMS_REC_DETAIL.RECEIPTKEY = WMS_RECEIPT.RECEIPTKEY
...
INNER JOIN ( select a.RECEIPTKEY,
                    ...
                    a.TYPE,
                    a.WHSEID
               from WMWHSE12.RECEIPT@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.CLOSEDDATE,
                    a.STATUS,
...
INNER JOIN ( select a.RECEIPTKEY,
                    a.SKU,
                    sum(a.QTYRECEIVED) QTDE
               from WMWHSE12.RECEIPTDETAIL@DL_LN_WMS  a
           group by a.RECEIPTKEY,
                    a.EXTERNRECEIPTKEY,
                    a.SKU ) WMS_REC_DETAIL
        ON WMS_REC_DETAIL.RECEIPTKEY = WMS_RECEIPT.RECEIPTKEY
...
SELECT RC.NUME_FILIAL,
       ...
       RC.ID_STATUS_NF,
       RC.DESCR_STATUS_NF,
       RC.CONDICAO_PAGTO_NR,
       RC.DESC_CONDICAO_PAGTO_NR,
       RC.CNPJ_FORNECEDOR,
       RC.NOME_FORNECEDOR,
       RC.DATA_RECEB_FISCAL,
       RC.NUME_CFOP,
       RC.NUME_ITEM,
       RC.DESC_ITEM,
       RC.GRUPO_DO_ITEM,
       RC.DESCR_GRUPO_DO_ITEM,
       RC.NUME_ORDEM,
       RC.CONDICAO_PAGTO_PEDIDO,
       RC.DESC_CONDICAO_PAGTO_PEDIDO,
       RC.CONDICAO_ENTREGA_NR,
       RC.DATA_GERACAO_PEDIDO,
       RC.DATA_PLANEJ_RECEBIMENTO,
       RC.SINALIZACAO_ITEM,
       RC.QTDE_RECEBIDA,
       RC.QTDE_ORDENADA,
       RC.QTDE_RECEBIDA_WMS,
       RC.ARMAZEM,
       RC.PRECO_UNITARIO,
       RC.VALOR_TOTAL_LINHA,
       RC.PRECO_TOTAL_ITEM,
       RC.COD_TIPO_DOCFISCAL,    
       RC.DSC_TIPO_DOCFISCAL,
       RC.COD_TIPO_DOC_RECFISCAL,
       RC.DSC_TIPO_DOC_RECFISCAL,
       RC.CHAVE_ACESSO,
       RC.NF_DEVOLUCAO,
       RC.SERIE_NF_DEVOLUCAO,
       RC.VALOR_ICMS,
       RC.VALOR_PIS,
       RC.VALOR_COFINS,
       RC.VALOR_IPI,
       RC.CHAVE_BUSCA_II,
       RC.EAN,
       RC.TIPO_ORDEM_COMPRA,
       RC.DESCRICAO_TIPO_ORDEM_DE_COMPRA,
       RC.LOGIN_GEROU_OC,
       RC.DSC_LOGIN_GEROU_OC,
       RC.NUM_ASN,
       RC.PLACA_VEICULO
  FROM VW_RPT_SPL_RECEBIMENTO_FISCAL RC
  
 WHERE Trunc(RC.DATA_RECEB_FISCAL) 
       Between :DtFiscalDe 
           And :DtFiscalAte
   AND RC.GRUPO_DO_ITEM IN (:GrupoItem)
   AND RC.ID_STATUS_NF IN (:Status)
   AND NVL(Trim(RC.COD_TIPO_DOCFISCAL), '0') in (:TipoDocFiscal)
   AND RC.COD_TIPO_DOC_RECFISCAL in (:TipoDocRecFiscal)
   AND ((:CNPJ Is Null) OR (regexp_replace(RC.CNPJ_FORNECEDOR, '[^0-9]', '') like '%' || Trim(:CNPJ) || '%'))
   
ORDER BY RC.NUME_FILIAL, 
         RC.REF_FISCAL, 
         RC.NUME_NOTA, 
         RC.NUME_ITEM