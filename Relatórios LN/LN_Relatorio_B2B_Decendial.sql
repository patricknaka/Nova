SELECT DISTINCT
  ...
  CASE WHEN ICMS.PERC=0.00 THEN
    0.00
  ELSE ICMS.BASE END            VL_BASE_ICMS,
  CASE WHEN IPI.PERC=0.00 THEN
    0.00
  ELSE IPI.BASE END             VL_BASE_IPI,
  CASE WHEN ICMSST.PERC=0.00 THEN
    0.00
  ELSE ICMSST.BASE END          VL_BASE_ICMS_ST,
  ICMS.VL                       VL_ICMS,
  IPI.VL                        VL_IPI,
...
AND   (cisli940f.t$stat$l=5 OR cisli940f.t$stat$l=6)
