...
FROM  baandb.ttcibd001201  tcibd001,
      baandb.ttibom010201  tibom010

LEFT JOIN   baandb.ttcibd001201  tcibd001a
       ON   tcibd001a.t$item = tibom010.t$sitm
       
LEFT JOIN   baandb.ttcmcs023201 tcmcs023a 
...
WHERE   tibom010.t$mitm = tcibd001.t$item
  AND   tcibd001.t$espe$c = iTABLE.CODE_STAT
