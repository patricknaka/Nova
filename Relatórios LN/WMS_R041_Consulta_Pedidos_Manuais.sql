...
"    ELSE WMS_ORDERS.ORDERKEY END PEDIDO_WMS,                " &
"    CASE WHEN CODELKUP.DESCRIPTION = ' ' THEN               " &
"      CODELKUP_OA.DESCRIPTION                               " &
"    ELSE CODELKUP.DESCRIPTION END DESCRICAO_PEDIDO,         " &
"    CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(cisli940.t$date$l,   " &
"      'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT') " &
...
"                             and l1.t$cpac = l.t$cpac ) ) FGET    " &
"        ON cisli940.t$fdty$l = FGET.CNST              " &
"      LEFT JOIN " + Parameters!Table.Value + ".ORDERS@DL_LN_WMS WMS_ORDERS " &
"             ON WMS_ORDERS.REFERENCEDOCUMENT = cisli245.t$slso      " &
"      LEFT JOIN " + Parameters!Table.Value + ".ORDERS@DL_LN_WMS WMS_OA_ORDERS " &
"      ON SUBSTR(WMS_OA_ORDERS.REFERENCEDOCUMENT,4,9) = CISLI245.T$SLSO  " &
"      LEFT JOIN " + Parameters!Table.Value + ".CODELKUP@DL_LN_WMS CODELKUP " &
...
"                             and l1.t$cpac = l.t$cpac ) ) FGET" &
"        ON cisli940.t$fdty$l = FGET.CNST                      " &
"      LEFT JOIN WMWHSE1.ORDERS@DL_LN_WMS WMS_ORDERS           " &
"             ON WMS_ORDERS.REFERENCEDOCUMENT = cisli245.t$slso " &
"      LEFT JOIN WMWHSE1.ORDERS@DL_LN_WMS WMS_OA_ORDERS        " &
"      ON SUBSTR(WMS_OA_ORDERS.REFERENCEDOCUMENT,4,9) = CISLI245.T$SLSO  " &
"      LEFT JOIN WMWHSE1.CODELKUP@DL_LN_WMS CODELKUP     " &
"        ON  CODELKUP.LISTNAME='ORDERTYPE'               " &
"        AND CODELKUP.CODE = WMS_ORDERS.TYPE             " &
...
"                             and l1.t$cpac = l.t$cpac ) ) FGET  " &
"        ON cisli940.t$fdty$l = FGET.CNST                        " &
"      LEFT JOIN WMWHSE2.ORDERS@DL_LN_WMS WMS_ORDERS             " &
"             ON WMS_ORDERS.REFERENCEDOCUMENT = cisli245.t$slso  " &
"      LEFT JOIN WMWHSE2.ORDERS@DL_LN_WMS WMS_OA_ORDERS          " &
"      ON SUBSTR(WMS_OA_ORDERS.REFERENCEDOCUMENT,4,9) = CISLI245.T$SLSO  " &
"      LEFT JOIN WMWHSE2.CODELKUP@DL_LN_WMS CODELKUP                     " &
"        ON  CODELKUP.LISTNAME='ORDERTYPE'                               " &
"        AND CODELKUP.CODE = WMS_ORDERS.TYPE                             " &
...
"                             and l1.t$cpac = l.t$cpac ) ) FGET          " &
"        ON cisli940.t$fdty$l = FGET.CNST                                " &
"      LEFT JOIN WMWHSE3.ORDERS@DL_LN_WMS WMS_ORDERS                     " &
"             ON WMS_ORDERS.REFERENCEDOCUMENT = cisli245.t$slso          " &
"      LEFT JOIN WMWHSE3.ORDERS@DL_LN_WMS WMS_OA_ORDERS                  " &
"      ON SUBSTR(WMS_OA_ORDERS.REFERENCEDOCUMENT,4,9) = CISLI245.T$SLSO  " &
"      LEFT JOIN WMWHSE3.CODELKUP@DL_LN_WMS CODELKUP                     " &
"        ON  CODELKUP.LISTNAME='ORDERTYPE'                               " &
"        AND CODELKUP.CODE = WMS_ORDERS.TYPE                             " &
...
"                             and l1.t$cpac = l.t$cpac ) ) FGET          " &
"        ON cisli940.t$fdty$l = FGET.CNST                                " &
"      LEFT JOIN WMWHSE4.ORDERS@DL_LN_WMS WMS_ORDERS                     " &
"             ON WMS_ORDERS.REFERENCEDOCUMENT = cisli245.t$slso          " &
"      LEFT JOIN WMWHSE4.ORDERS@DL_LN_WMS WMS_OA_ORDERS                  " &
"      ON SUBSTR(WMS_OA_ORDERS.REFERENCEDOCUMENT,4,9) = CISLI245.T$SLSO  " &
"      LEFT JOIN WMWHSE4.CODELKUP@DL_LN_WMS CODELKUP                     " &
"        ON  CODELKUP.LISTNAME='ORDERTYPE'                               " &
"        AND CODELKUP.CODE = WMS_ORDERS.TYPE                             " &
...
"                             and l1.t$cpac = l.t$cpac ) ) FGET          " &
"        ON cisli940.t$fdty$l = FGET.CNST                                " &
"      LEFT JOIN WMWHSE6.ORDERS@DL_LN_WMS WMS_ORDERS                     " &
"             ON WMS_ORDERS.REFERENCEDOCUMENT = cisli245.t$slso          " &
"      LEFT JOIN WMWHSE6.ORDERS@DL_LN_WMS WMS_OA_ORDERS                  " &
"      ON SUBSTR(WMS_OA_ORDERS.REFERENCEDOCUMENT,4,9) = CISLI245.T$SLSO  " &
"      LEFT JOIN WMWHSE6.CODELKUP@DL_LN_WMS CODELKUP   " &
"        ON  CODELKUP.LISTNAME='ORDERTYPE'             " &
"        AND CODELKUP.CODE = WMS_ORDERS.TYPE           " &
...
"                             and l1.t$cpac = l.t$cpac ) ) FGET " &
"        ON cisli940.t$fdty$l = FGET.CNST                       " &
"      LEFT JOIN WMWHSE7.ORDERS@DL_LN_WMS WMS_ORDERS            " &
"             ON WMS_ORDERS.REFERENCEDOCUMENT = cisli245.t$slso " &
"      LEFT JOIN WMWHSE7.ORDERS@DL_LN_WMS WMS_OA_ORDERS         " &
"      ON SUBSTR(WMS_OA_ORDERS.REFERENCEDOCUMENT,4,9) = CISLI245.T$SLSO  " &
"      LEFT JOIN WMWHSE7.CODELKUP@DL_LN_WMS CODELKUP   " &
"        ON  CODELKUP.LISTNAME='ORDERTYPE'             " &
"        AND CODELKUP.CODE = WMS_ORDERS.TYPE           " &
