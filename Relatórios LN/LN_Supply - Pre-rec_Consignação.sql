...
WHERE   brnfe940.t$fire$l = brnfe941.t$fire$l  
  ...
  AND   tdpur400.t$orno = znnfe007.t$orno$c 
  AND   tdpur400.t$orno = tdpur401.t$orno 
  AND   tdpur094.t$potp = tdpur400.t$cotp 
