  ...
  DISTINCT
    ...
    CASE WHEN tfcmg101.t$tadv = 5 --Pagamento Adiantado
           THEN CASE WHEN tfcmg103.t$paid = 1 
                     ...
                     ELSE   99        -- Criado
                 END   
         WHEN tfcmg101.t$tadv IN (3,4) --Nota de Credito de Venda     --hmk
...
--and   tfcmg101.t$btno = 2839
  ...
  AND CASE WHEN tfcmg101.t$tadv = 5 --Pagamento Adiantado
             THEN CASE WHEN tfcmg103.t$paid = 1 
                       ...
                       ELSE   'Criado'  
                  END
           WHEN tfcmg101.t$tadv IN (3,4) -- 1-Fatura de Venda, 4-Nota de Credito de Venda
             THEN StatusCreditoVenda.DESC_STATUSCREDITOVENDA
           ELSE iPrgStat.DESCR 
      END IN (:StatusPagto)
