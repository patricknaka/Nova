Select Q1.* 
 From ( SELECT 
            ...
            CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(znsls400ret.t$dtin$c, 
                  'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT')
                    AT time zone 'America/Sao_Paulo') AS DATE) 
                                         DT_OCORR,
            CASE WHEN znfmd630ret.t$stat$c = 1
                   THEN 'ABERTO' 
                 ELSE   'FECHADO'
            END                          SITUACAO,
  ...
  INNER JOIN BAANDB.tznsls409301 znsls409
          ON znsls409.t$ncia$c = znsls401ret.t$ncia$c 
         AND znsls409.t$uneg$c = znsls401ret.t$UNEG$c 
         AND znsls409.t$pecl$c = znsls401ret.t$pecl$c 
         AND znsls409.t$sqpd$c = znsls401ret.t$sqpd$c
         AND znsls409.t$entr$c = znsls401ret.t$entr$c
