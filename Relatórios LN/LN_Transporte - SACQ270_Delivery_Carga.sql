Select Q1.* From 
     ( SELECT 
         ...
         ( select a.t$desc$c 
             from baandb.tznint002201 a
            where a.t$ncia$c = znsls400ret.t$ncia$c
              and a.t$uneg$c = znsls400ret.t$uneg$c ) 
                                      DESCR_UNID_NEG
        
       FROM      BAANDB.tcisli940201  cisli940ret 
       
       LEFT JOIN BAANDB. tznfmd630201  znfmd630ret
              ON znfmd630ret.t$fire$c = cisli940ret.t$fire$l 
			  
       LEFT JOIN BAANDB. tznfmd001201  znfmd001ret
              ON znfmd001ret.t$fili$c = znfmd630ret.t$fili$c
           
       LEFT JOIN BAANDB.tznfmd640201  znfmd640ret
              ON znfmd640ret.t$fili$c = znfmd630ret.t$fili$c 
             AND znfmd640ret.t$etiq$c = znfmd630ret.t$etiq$c
      
       LEFT JOIN BAANDB.ttccom130201  tccom130cli
              ON tccom130cli.t$cadr = cisli940ret.t$stoa$l  
       
       LEFT JOIN BAANDB.ttcmcs080201  tcmcs080ret
              ON tcmcs080ret.t$cfrw = CISLI940ret.T$CFRw$L
       
       LEFT JOIN BAANDB.ttccom130201  tccom130ret
              ON tccom130ret.t$cadr = tcmcs080ret.t$cadr$l,
       
                 BAANDB.tcisli940201  cisli940ori
        
       LEFT JOIN ttcmcs080201  tcmcs080ori
              ON tcmcs080ori.t$cfrw = CISLI940ORI.T$CFRw$L
       
       LEFT JOIN BAANDB.ttccom130201  tccom130ori
              ON tccom130ori.t$cadr = tcmcs080ori.t$cadr$l
       
       LEFT JOIN BAANDB.tznfmd630201  znfmd630ori
              ON znfmd630ori.t$fire$c = cisli940ori.t$fire$l,
       
                 BAANDB.tcisli245201  cisli245ret   
        
       LEFT JOIN BAANDB.tcisli941201  cisli941ret  
              ON cisli941ret.t$fire$l = cisli245ret.t$fire$l
             AND cisli941ret.t$line$l = cisli245ret.t$line$l,
           
                 BAANDB.tcisli245201  cisli245ori,
                 BAANDB.tznsls401201  znsls401ori
        
       LEFT JOIN BAANDB.tznsls401201  znsls401gar
             ...
             AND znsls401gar.t$sgar$c = znsls401ori.t$sequ$c, 
                 ...
                 BAANDB.tznsls400201  znsls400ret,                  
                 BAANDB.ttdsls401201  tdsls401ret  
        
       LEFT JOIN BAANDB.tznsls401201  znsls401ret
              ON tdsls401ret.t$orno = znsls401ret.t$orno$c
             AND tdsls401ret.t$pono = znsls401ret.t$pono$c
      
       LEFT JOIN BAANDB.tznsls010201 znsls010 
              ON znsls010.t$ccat$c=znsls401ret.t$ccat$c
   
       LEFT JOIN BAANDB.tznsls011201 znsls011 
              ON znsls011.t$ccat$c=znsls401ret.t$ccat$c
             AND znsls011.t$cass$c=znsls401ret.t$cass$c
        
       LEFT JOIN BAANDB.tznsls012201 znsls012 
