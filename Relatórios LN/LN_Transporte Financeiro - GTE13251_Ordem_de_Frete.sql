select Q1.*,
       Round( (Q1.PESO_VOLUME + Q1.AD_VALOREM + Q1.PEDAGIO + Q1.ADICIONAIS) /
              (1-(ALIQUOTA/100)) -
              (Q1.PESO_VOLUME + Q1.AD_VALOREM + Q1.PEDAGIO + Q1.ADICIONAIS), 4 )   VLR_ICMS, 
       Round( (Q1.PESO_VOLUME + Q1.AD_VALOREM + Q1.PEDAGIO + Q1.ADICIONAIS) /
              (1-(ALIQUOTA/100)) -
              (Q1.PESO_VOLUME + Q1.AD_VALOREM + Q1.PEDAGIO + Q1.ADICIONAIS) +
              (Q1.AD_VALOREM + Q1.PEDAGIO + Q1.ADICIONAIS + Q1.PESO_VOLUME), 4 )   FRETE_TOTAL,
