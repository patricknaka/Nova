select  q2.t$uneg$c                       ID_UNEG,
        ...
        CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(Q2.DATA_OCORR, 'DD-MON-YYYY HH24:MI:SS'), 
...
INNER JOIN  BAANDB.TTDSLS400301 TDSLS400 	ON TDSLS400.T$ORNO = Q1.T$ORNO
...
INNER JOIN (select distinct   a.t$ncia$c,
                              ...
                              a.t$itpe$c,
							  a.t$dtep$c
            from baandb.tznsls401301 a) ENTR  ON  ENTR.T$NCIA$C = Q2.T$NCIA$C
