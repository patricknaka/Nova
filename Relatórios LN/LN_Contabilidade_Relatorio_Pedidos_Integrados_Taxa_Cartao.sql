SELECT
  DISTINCT
    ...
    nvl(TO_CHAR(zncmg010.t$trbd$c, '990.99'), ' ') 	TAXA_CARTAO,
...
LEFT JOIN (								-- data de inicio da vigencia
		select	zncmg010_.t$band$c,
				zncmg010_.t$adqu$c,
				zncmg010_.t$cias$c,
				max(zncmg010_.t$dtin$c) DATA_INICIO
		from		baandb.tzncmg010301 zncmg010_		
		group by 	zncmg010_.t$band$c, zncmg010_.t$adqu$c, zncmg010_.t$cias$c) zncmg010_dt
...
LEFT JOIN (								-- numero de parcelas
		...
		from		baandb.tzncmg010301 zncmg010_		
		group by 	zncmg010_.t$band$c, zncmg010_.t$adqu$c, zncmg010_.t$cias$c, zncmg010_.t$dtin$c) zncmg010_np
