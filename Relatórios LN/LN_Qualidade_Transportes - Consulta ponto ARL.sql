...
(SELECT
		...
		ROW_NUMBER() OVER (PARTITION BY ZNSLS410.T$NCIA$C, ZNSLS410.T$UNEG$C, ZNSLS410.T$PECL$C, ZNSLS410.T$SQPD$C, ZNSLS410.T$ENTR$C 
                       ORDER BY ZNSLS410.T$DTOC$C DESC, ZNSLS410.T$SEQN$C DESC) 	RN
FROM
		BAANDB.TZNSLS410201 ZNSLS410
INNER JOIN  BAANDB.TZNMCS002201 ZNMCS002  ON  ZNMCS002.T$POCO$C = ZNSLS410.T$POCO$C) Q1
