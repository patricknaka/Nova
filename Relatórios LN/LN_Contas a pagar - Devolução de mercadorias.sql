SELECT
  DISTINCT
    ...
    tdrec940o.t$ttyp$l ||          
    tdrec940o.t$invn$l           TRANSACAO_ORIGEM,

    tdrec940o.t$docn$l           NF_ORIGEM,
    tdrec940o.t$seri$l           SERIE_ORIGEM,

    tfacp200o.t$docd             DT_EMISSAO_NF_ORIGEM,

    tfacp200o.t$dued             DT_VENCTO_NF_ORIGEM,
    ...
    tfacp201o.t$pyst$l            STATUS_PAG_NF,
    ...
    tdrec940.T$DOCN$L            NFD,
    tdrec940.T$SERI$L            SERIE_NFD,
...
FROM       baandb.ttdrec940201 tdrec940
 ...
 LEFT JOIN baandb.ttfacp201201 tfacp201o
        ON tdrec940o.t$ttyp$l = tfacp201o.t$ttyp 
       AND tdrec940o.t$invn$l = tfacp201o.t$ninv
       AND tfacp201o.t$paia != 0
     
 LEFT JOIN baandb.ttfcmg101201 tfcmg101r
        ON tfcmg101r.t$ttyp = tfacp201o.t$ttyp
       AND tfcmg101r.t$ninv = tfacp201o.t$ninv
 ...
 LEFT JOIN ( select l.t$desc DESCR_STATUS_PAG_NF,
        ...
        ON STATUS_PAG_NF.t$cnst = tfacp201o.t$pyst$l  
