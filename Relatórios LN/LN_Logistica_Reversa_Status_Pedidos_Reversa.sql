select
        ...
        case when znsls410_TRACKING.POCO is not null then
             znsls410_TRACKING.POCO
        else
             'ERRO'
        end                               OCORRENCIA,
...
left join  ( select a.t$ncia$c,
              ...
              group by  a.t$ncia$c,
                        ...
                        a.t$pecl$c,
                        a.t$sqpd$c,
                        a.t$entr$c) znsls410_TRACKING
        on  znsls410_TRACKING.t$ncia$c = znsls401.t$ncia$c
       and  znsls410_TRACKING.t$uneg$c = znsls401.t$uneg$c
       and  znsls410_TRACKING.t$pecl$c = znsls401.t$pecl$c
       and  znsls410_TRACKING.t$sqpd$c = znsls401.t$sqpd$c
       and  znsls410_TRACKING.t$entr$c = znsls401.t$entr$c
