...
INNER JOIN	BAANDB.TTCMCS065301	TCMCS065	ON	TCMCS065.T$CWOC		=	CISLI940.T$COFC$L
...
INNER JOIN	BAANDB.TTCCOM130301 TCCOM130F	ON	TCCOM130F.T$CADR	=	CISLI940.T$ITOA$L
INNER JOIN	BAANDB.TCISLI941301	CISLI941	ON	CISLI941.T$FIRE$L	=	CISLI940.T$FIRE$L
INNER JOIN	BAANDB.TCISLI245301	CISLI245	ON	CISLI245.T$FIRE$L	=	CISLI941.T$FIRE$L
...
LEFT JOIN	BAANDB.TWHINH200301	WHINH200	ON	WHINH200.T$OORG = 	KOOR2OORG.OORG
											AND	WHINH200.T$ORNO	=	CISLI245.T$SLSO
											
LEFT JOIN	BAANDB.TWHINH010301	WHINH010	ON	WHINH010.T$OTYP	=	WHINH200.T$OTYP
