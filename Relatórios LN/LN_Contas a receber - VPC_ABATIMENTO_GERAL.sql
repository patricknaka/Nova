select Q1.* 
 ...
 where Q1.ID_DEPTO IN (:Depto)
   and Trunc(Q1.DT_ASSINATURA)
       Between :DataAssinaturaDe
           And :DataAssinaturaAte
   and Q1.VPC.STATUS IN (:SituacaoContrato)		   
