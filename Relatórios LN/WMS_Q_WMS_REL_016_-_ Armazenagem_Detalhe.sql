...
INNER JOIN WMWHSE5.SKU                                    
 ...
 LEFT JOIN WMWHSE5.lotxloc ll_ORIGEM
        ON ll_ORIGEM.LOC = IT.FROMLOC
       
 LEFT JOIN WMWHSE5.lotxloc ll_DESTINO
...
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN " + Parameters!Table.Value + ".lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN " + Parameters!Table.Value + ".lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
...
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN WMWHSE1.lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN WMWHSE1.lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
...
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN WMWHSE2.lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN WMWHSE2.lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
...
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN WMWHSE3.lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN WMWHSE3.lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
...
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN WMWHSE4.lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN WMWHSE4.lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
...
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN WMWHSE6.lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN WMWHSE6.lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
...
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN WMWHSE7.lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN WMWHSE7.lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
...
"        NVL(maucLN.mauc, 0) * IT.QTY         VALOR  " &
"  " &
" FROM       WMWHSE8.ITRN  IT  " &
"  " &
" INNER JOIN WMWHSE8.SKU  " &
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN WMWHSE8.lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN WMWHSE8.lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
...
"         ON tu.userkey = IT.EDITWHO  " &
"  " &
"  LEFT JOIN WMWHSE8.LOC  aTOLOC  " &
"         ON aTOLOC.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN WMWHSE8.LOC  " &
"         ON LOC.LOC = IT.FROMLOC  " &
"  " &
" INNER JOIN WMSADMIN.PL_DB  WMSADMIN  " &
"         ON UPPER(WMSADMIN.DB_LOGID) = IT.WHSEID  " &
"  " &
"  LEFT JOIN WMWHSE8.STORER  " &
"         ON STORER.STORERKEY = sku.SUSR5  " &
"        AND STORER.WHSEID = sku.WHSEID  " &
"        AND STORER.TYPE = 5  " &
"  " &
...
"        NVL(maucLN.mauc, 0) * IT.QTY         VALOR  " &
"  " &
" FROM       WMWHSE11.ITRN  IT  " &
"  " &
" INNER JOIN WMWHSE11.SKU  " &
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN WMWHSE11.lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN WMWHSE11.lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
"        AND TO_CHAR(DEPARTSECTORSKU.ID_SECTOR) = TO_CHAR(SKU.SKUGROUP2)  " &
"  " &
"  LEFT JOIN WMWHSE11.taskmanageruser  tu  " &
"         ON tu.userkey = IT.EDITWHO  " &
"  " &
"  LEFT JOIN WMWHSE11.LOC  aTOLOC  " &
"         ON aTOLOC.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN WMWHSE11.LOC  " &
"         ON LOC.LOC = IT.FROMLOC  " &
"  " &
" INNER JOIN WMSADMIN.PL_DB  WMSADMIN  " &
"         ON UPPER(WMSADMIN.DB_LOGID) = IT.WHSEID  " &
"  " &
"  LEFT JOIN WMWHSE11.STORER  " &
"         ON STORER.STORERKEY = sku.SUSR5  " &
"        AND STORER.WHSEID = sku.WHSEID  " &
"        AND STORER.TYPE = 5  " &
"  " &
...
"        NVL(maucLN.mauc, 0) * IT.QTY         VALOR  " &
"  " &
" FROM       WMWHSE12.ITRN  IT  " &
"  " &
" INNER JOIN WMWHSE12.SKU  " &
"         ON SKU.SKU = IT.SKU  " &
"  " &
"  LEFT JOIN WMWHSE12.lotxloc ll_ORIGEM  " &
"         ON ll_ORIGEM.LOC = IT.FROMLOC  " &
"  " &
"  LEFT JOIN WMWHSE12.lotxloc ll_DESTINO  " &
"         ON ll_DESTINO.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN ENTERPRISE.DEPARTSECTORSKU  DEPARTSECTORSKU  " &
"         ON TO_CHAR(DEPARTSECTORSKU.ID_DEPART) = TO_CHAR(SKU.SKUGROUP)  " &
"        AND TO_CHAR(DEPARTSECTORSKU.ID_SECTOR) = TO_CHAR(SKU.SKUGROUP2)  " &
"  " &
"  LEFT JOIN WMWHSE12.taskmanageruser  tu  " &
"         ON tu.userkey = IT.EDITWHO  " &
"  " &
"  LEFT JOIN WMWHSE12.LOC  aTOLOC  " &
"         ON aTOLOC.LOC = IT.TOLOC  " &
"  " &
"  LEFT JOIN WMWHSE12.LOC  " &
"         ON LOC.LOC = IT.FROMLOC  " &
"  " &
" INNER JOIN WMSADMIN.PL_DB  WMSADMIN  " &
"         ON UPPER(WMSADMIN.DB_LOGID) = IT.WHSEID  " &
"  " &
"  LEFT JOIN WMWHSE12.STORER  " &
"         ON STORER.STORERKEY = sku.SUSR5  " &
"        AND STORER.WHSEID = sku.WHSEID  " &
"        AND STORER.TYPE = 5  " &
"  " &
