select Q1.* 
  from ( SELECT 
           DISTINCT
             ...
             CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(tccom130.t$crdt, 
             ...
             CAST((FROM_TZ(TO_TIMESTAMP(TO_CHAR(tccom130.t$dtlm, 
               'DD-MON-YYYY HH24:MI:SS'), 'DD-MON-YYYY HH24:MI:SS'), 'GMT') 
                 AT time zone 'America/Sao_Paulo') AS DATE)
                                ALTERADO_EM,
         ...
         INNER JOIN baandb.ttccom130301 tccom130
          ...
          LEFT JOIN baandb.ttcmcs013301 tcmcs013c
                 ON tcmcs013c.t$cpay = tccom112.t$cpay  ) Q1
  
where Trunc(Q1.CRIADO_EM) 
      Between NVL(:DtCadDe,  Q1.CRIADO_EM)   
          And NVL(:DtCadAte, Q1.CRIADO_EM) 
  
  and Trunc(Q1.ALTERADO_EM)  
      Between NVL(:DtAltDe,  Q1.ALTERADO_EM) 
          And NVL(:DtAltAte, Q1.ALTERADO_EM)