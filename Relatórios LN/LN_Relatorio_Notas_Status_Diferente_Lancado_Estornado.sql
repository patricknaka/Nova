  ...
  from ( SELECT DISTINCT
     ...
     INNER JOIN baandb.ttccom130301 tccom130
      ...
      LEFT JOIN baandb.tznfmd001301 znfmd001
             ON znfmd001.t$fili$c = tcemm030.t$euca
                   
          WHERE cisli940.t$stat$l != 6
            AND cisli940.t$stat$l != 101 ) Q1
	   
where Trunc(Q1.DATA_GERACAO_NF)
      Between :DataRefFiscalDe
          And :DataRefFiscalAte
  and Q1.SITUACAO_NF in (:SituacaoNF)
  and ( (:RFiscalTodos = 1) or (Q1.REF_FISCAL in (:RFiscal) and (:RFiscalTodos = 0)) )