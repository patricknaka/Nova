...
(SELECT
		...
		ZNISA001.T$DSCA$C				TIPO_NAO_PRODUTO
...
FROM
		...
		LEFT JOIN	BAANDB.TZNISA002201 ZNISA002	ON	ZNISA002.T$NPCL$C	=	TCIBD001.T$NPCL$C
		LEFT JOIN	BAANDB.TZNISA001201 ZNISA001	ON	ZNISA001.T$NPTP$C	=	ZNISA002.T$NPTP$C
