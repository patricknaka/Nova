...
CREATE TABLE [dbo].[ods_relatorio_rentab](
	[data_pedido] [datetime] NULL,
	[ano_pedido] [int] NULL,
	[mes_pedido] [int] NULL,
	[dia_pedido] [int] NULL,
	[data_faturamento] [datetime] NULL,
	[ano_faturamento] [int] NULL,
	[mes_faturamento] [int] NULL,
	[dia_faturamento] [int] NULL,
	[SKU] [numeric](18, 0) NULL,
	[vl_total_faturado] [numeric](38, 2) NULL,
	[valor_prod] [numeric](38, 2) NULL,
	[vl_desc_inc] [numeric](38, 2) NULL,
	[RecLiqProd] [numeric](38, 2) NULL,
	[qt_itens] [numeric](38, 0) NULL,
	[vl_cmv] [numeric](38, 2) NULL,
	[ValorMgProd] [numeric](38, 2) NULL,
	[vl_frete] [numeric](38, 2) NULL,
	[vl_custo_frete] [numeric](38, 2) NULL,
	[VL_LUCRO_LIQUIDO_GE] [int] NULL,
	[VL_AVP] [numeric](38, 7) NULL,
	[VL_TARIFA] [numeric](38, 2) NULL,
	[VL_DESPREZO_CRED] [numeric](38, 2) NULL,
	[Regiao] [varchar](12) NULL,
	[Estado] [varchar](2) NULL,
	[tipo_localidade] [varchar](20) NULL,
	[unidade_negocio] [varchar](50) NULL,
	[tipo_faturamento] [int] NULL,
	[ds_meio_pagto] [varchar](50) NULL,
	[MgLiq] [numeric](38, 6) NULL,
	[MgProduto] [numeric](38, 6) NULL,
	[ParcelaMedia] [numeric](38, 6) NULL,
	[ValorMgLiq] [numeric](38, 2) NULL,
	[VL_NOTA] [numeric](38, 2) NULL,
	[DS_CANAL] [varchar](50) NULL,
	[ID_LC] [bit] NULL,
	[ds_canal_marketing] [varchar](100) NULL,
	[DS_DEPTO] [varchar](50) NULL,
	[DS_SETOR] [varchar](50) NULL,
	[DS_FAMILIA] [varchar](80) NULL,
	[DS_PRODUTO_LOJA] [varchar](150) NULL,
	[ReceitaGE] [numeric](38, 26) NULL,
	[CustoDesfinanciamento] [numeric](38, 26) NULL,
	[Estabelecimento] [varchar](20) NULL,
	[ds_fornecedor] [varchar](50) NULL,
	[cnpj_fornecedor] [numeric](14, 0) NULL,
	[VL_REC_LIQ_PRODUTO] [numeric](38, 2) NULL,
	[VL_PARCELA_CALC] [numeric](38, 2) NULL,
	[ReceitaFrete] [numeric](38, 6) NULL
) ON [PRIMARY]
