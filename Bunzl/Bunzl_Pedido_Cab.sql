...
SELECT
		...
		ZNSLS400.T$DTEM$C													DT_EMISSAO_PED,
		ZNSLS400.T$ICLF$C													CNPJ_CLIENTE,
		...
		ZNSLS401.T$IDTR$C													CNPJ_TRANSP,		-- CNPJ DA TRANSPORTADORA QUE FOI CARRGADO PELO FRONT NA INTEGRAÇÃO DO PEDIDO
		'01'																TIPO_OPERACAO,
		ZNSLS400.T$PEEX$C													PEDIDO_CLIENTE
